...
var TimeFreeTitle = "*政府指导价200-2000元/小时上下浮动幅度：20%";
var RiskFreeTitle = "风险代理收费的金额不得高于收费合同约定标的的30%。";
var FreeRule = "无";
//计件收费
var JiJianArr = [{
    cases: "刑事案件", desArr: [
        { name: "侦查阶段", price: " 2000元-20000元/件" },
        { name: "审查起诉阶段", price: "2000元-20000元/件" },
        { name: "审判阶段一审基层法院", price: "2000元-20000元/件" },
        { name: "审判阶段一审中级及以上法院", price: "5000元-50000元/件" },
        { name: "审判阶段一审基层法院", price: "3000-30000元/件" },
        { name: "申诉阶段基层法院", price: "2000元-20000元/件" },
        { name: "申诉阶段中级及以上法院", price: "5000元-50000元/件" },
        { name: "自诉案件代理", price: "2000元-20000元/件" }
    ],
    CivilAction: [{ type: "民事、行政诉讼", name: "立案", price: "2000元- 30000元/件" }],
    Important: 0
}];
/**
RatioFees ：比例收费
