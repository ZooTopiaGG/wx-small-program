...
function createTime2(tt, returnType){
  if (tt) {
    var dt = new Date(parseInt(tt.slice(6, 19)));
...
function createTime1(tt, returnType) {
  if (tt) {
    var dt = new Date(parseInt(tt.slice(6, 19)));
...
module.exports.createTime1 = createTime1
module.exports.createTime2 = createTime2
